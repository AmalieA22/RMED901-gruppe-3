...
-If the distribution of ct_results differ with the sex groups
...
>>>>>>> dad8d7d01e68303044ec751cc9d7337aa1a7e1b2
...
To do the t-test we first co removed "invalid" from results. We then coded the "positive" and "negative" in results as 1 and 0. We then performed the t-test.
```{r}
data_wrangled %>% 
  subset(result != "invalid") %>% 
  mutate(result = if_else(result == "positive", 1, 0)) %>% 
